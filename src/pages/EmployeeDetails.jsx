...
const EmployeeDetails = ({ isModalOpen, handleOk, handleCancel, employee }) => {
    ...
    const modalWidth = isSmall ? '95%' : 1000
    const containerPadding = isSmall ? 'p-6' : 'p-10'
    const layoutDirection = isSmall ? 'flex-col' : 'flex-row'
    const profileSize = isSmall ? 120 : isMedium ? 160 : 200
    const popIconSize = isSmall ? 18 : 20
                ...
                >
                    <div>
                        <Form form={form} initialValues={employee} layout="vertical">
                            <div className={`flex gap-5 ${containerPadding} ${layoutDirection}`}>
                                <div className='flex flex-col gap-7 items-center'>
                                    <CgProfile size={profileSize} />
                ...
                : (
                    <Modal
                        ...
                        footer={[
                            ...
                            <Button key='delete' type='primary' onClick={() => handleDelete(employee.firstName)} danger>
                                Delete
                            </Button>
                        ]}
                    >
                            ...
                            <div className='flex flex-col gap-7 items-center'>
                                ...
                                <div className='flex gap-7'>
                                    <Popover content={employee.degree}>
                                        <GiGraduateCap size={popIconSize} />
                                    </Popover>
                                    <Popover content={employee.phone}>
                                        <FiPhoneCall size={popIconSize} />
                                    </Popover>
                                    <Popover content={employee.email}>
                                        <MdOutlineMail size={popIconSize} />
                                    </Popover>
                                </div>
                            </div>
                            <div className='flex flex-col p-6 gap-3 w-full'>
